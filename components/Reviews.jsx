...
const Reviews = () => {
  return  <>
    ...
    <div className='lg:max-w-[1200px] max-w-[90vw] m-auto mt-20 '>
    ...
    <div className="customerCard mt-16 flex flex-col lg:flex-row gap-7 lg:gap-1 lg:justify-center lg:max-w-[1200px] m-auto "> 
