...
const Reviews = () => {
  return  <>
    ...
    <div className="customerCard mt-16 flex gap-7"> 
      <div className="customerCard1 w-[384px] h-[239px] noise-bg rounded-md m-auto">
        <div className="flex  justify-start ml-4 mt-5 items-center">
         ...
         <h1 className='ml-7 max-w-[500px] '>Using this AI-powered design assistant has completetly transformed the way i approach my projects. It's like having a professional desginer on call 24/7. Highly recommend it!</h1>
      </div>
    </div>
  </>
}
