...
const Section2 = () => {
  return (
    <>
        <div className="container lg:max-w-[1200px] lg:max-h[471px] m-auto flex lg:justify-between items-center lg:mb-20 w-[90vw] flex-col-reverse lg:flex-row mb-20 ">
        ...
        <div className="container lg:max-w-[1200px] lg:max-h[471px] m-auto flex lg:justify-between lg:items-center lg:mb-20 w-[90vw] flex-col-reverse lg:flex-row-reverse mb-20">
             <div className="textbox mt-14"> 
        ...
        <div className="container lg:max-w-[1200px] lg:max-h[471px] m-auto flex lg:justify-between lg:items-center lg:mb-20 w-[90vw] flex-col-reverse lg:flex-row mb-20 ">
            <div className="textbox mt-14"> 
