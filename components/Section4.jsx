...
const Section4 = () => {
  return (
    <div className='sm:max-w-[1200px] max-w-[90vw] m-auto rounded-3xl mt-18
     noise-bg overflow-hidden w-[90vw] h-[460px] flex sm:items-center p-4 '>  
        ...
        <div className="sm:w-[40vw] sm:h-[450px] mx-auto  relative">
          <div className="itemIcon item1 "><img src="/marqueeImg/a.avif"/></div>
          <div className="itemIcon item2 absolute"><img src="/marqueeImg/b.avif"/></div>
          <div className="itemIcon item3 absolute"><img src="/marqueeImg/c.avif"/></div>
          <div className="itemIcon item4 absolute"><img src="/marqueeImg/d.avif"/></div>
          <div className="itemIcon item5 absolute"><img src="/marqueeImg/e.avif"/></div>
