  ...
  return (
    <div className='section w-[90vw] h-auto max-w-[1200px] m-auto mt-30 mb-40'>
        <div className="textblock2 ">
            ...
            <h2 className='sm:max-w-[35vw]  max-w-[80vw] '>Discover how our AI-Powered Design Assistant transforms your ideas into stunning designs effortlessly. Follow these simple steps to turn your vision into reality.</h2>
        </div>


        <div className="sectionCards flex flex-row gap-7 mt-10 sm:flex-col sm:mt-1">

          <div className="secCard card1  min-w-[387px] min-h-[239px] max-w-[387px] max-h-[239px] relative sm:max-w-[80vw]
             m-auto sm:m-0 rounded-2xl mt-18 sm:mt-10 noise-bg overflow-hidden">
            ...
            <div className="secCard card2  min-w-[387px] min-h-[239px] max-w-[387px] max-h-[239px] relative sm:min-w-[80vw]
             m-auto sm:m-0 rounded-2xl mt-18 sm:mt-5 noise-bg overflow-hidden">
              <div className="secIcon rounded-[50%] w-[50px] h-[50px] bg-[#8f4ded]  m-5 absolute">
            ...
            <div className="secCard card3  min-w-[387px] min-h-[239px] max-w-[387px] max-h-[239px] relative sm:min-w-[80vw]
             m-auto sm:m-0 rounded-2xl mt-18 sm:mt-5 noise-bg overflow-hidden">
              <div className="secIcon rounded-[50%] w-[50px] h-[50px] bg-[#8f4ded]  m-5 absolute">
