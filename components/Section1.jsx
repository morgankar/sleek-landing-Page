...
const Section1 = () => {
  return (
    <div className='section w-[90vw] h-auto max-w-[1200px] m-auto mt-30 mb-30'>
        ...
        <div className="sectionCards flex flex-row gap-7 mt-10">
          ...
          <div className="secCard card1  min-w-[387px] min-h-[239px] max-w-[387px] max-h-[239px] relative
            ...
            <div className="secCard card2  min-w-[387px] min-h-[239px] max-w-[387px] max-h-[239px] relative
             m-auto rounded-2xl mt-18 noise-bg overflow-hidden">
              <div className="secIcon rounded-[50%] w-[50px] h-[50px] bg-[#8f4ded]  m-5 absolute">
            ...
            <div className="secCard card3  min-w-[387px] min-h-[239px] max-w-[387px] max-h-[239px] relative
             m-auto rounded-2xl mt-18 noise-bg overflow-hidden">
              <div className="secIcon rounded-[50%] w-[50px] h-[50px] bg-[#8f4ded]  m-5 absolute">
