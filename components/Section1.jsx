...
const Section1 = () => {
  return (
    <div className='section w-[90vw] h-auto sm:max-w-[1200px] m-auto mt-40 mb-26'>
        ...
        <div className="sectionCards flex flex-col gap-7 sm:flex-row md:flex-col lg:flex-row sm:mt-10 w-[90vw]">
          ...
          <div className="secCard card1 sm:min-w-[387px] min-w-[90vw] min-h-[239px] max-w-[387px] max-h-[239px] relative sm:max-w-[80vw] 
            ...
            <div className="secCard card2 min-w-[90vw] sm:min-w-[387px] min-h-[239px] max-w-[387px] max-h-[239px] relative 
             m-auto sm:m-0 rounded-2xl mt-2 sm:mt-5 noise-bg sm:max-w-[80vw] overflow-hidden">
              <div className="secIcon rounded-[50%] w-[50px] h-[50px] bg-[#8f4ded]  m-5 absolute">
            ...
            <div className="secCard card3 min-w-[90vw] sm:min-w-[387px] min-h-[239px] max-w-[387px] max-h-[239px] relative sm:max-w-[80vw]
             m-auto sm:m-0 rounded-2xl mt-2 sm:mt-5 noise-bg overflow-hidden">
              <div className="secIcon rounded-[50%] w-[50px] h-[50px] bg-[#8f4ded]  m-5 absolute">
